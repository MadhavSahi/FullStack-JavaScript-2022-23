...
userSchema.methods={
    ...
    generateForgotPasswordToken : function(){
        ...
        return forgotToken; //we are returning forgotToken to backend bcz we have to compare the Token values of DB and user mail one...it will be used in controller.
    },
